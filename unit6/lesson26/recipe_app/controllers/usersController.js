...
module.exports = {
  ...
  indexView: (req, res) => {
    if (req.query.format === "json") {
      res.json(res.locals.courses);//Respond with JSON if the format query param equals json. get courses from courses and responding as json
    } else {
      //responds with courses table
  ...
  //...............................................................
  logout: (req, res, next) => { //add an actiion to log users out
    req.logout();
